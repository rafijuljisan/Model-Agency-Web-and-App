...
<head>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($seo?->tiktok_pixel_id): ?>
        <script>
            !function (w, d, t) {
                ...
                ttq.load('<?php echo e($seo->tiktok_pixel_id); ?>');
                ttq.page();
            }(window, document, 'ttq');
        </script>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="topbar-left">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($settings->contact_phone): ?>
                    <a href="tel:<?php echo e($settings->contact_phone); ?>" aria-label="Call us">
                        ...
                        <span class="topbar-call-text">Call Us:&nbsp;</span><?php echo e($settings->contact_phone); ?>
...
[$__name, $__params] = $__split('grooming-apply-modal');
...
$__key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-3437951620-0', $__key);
