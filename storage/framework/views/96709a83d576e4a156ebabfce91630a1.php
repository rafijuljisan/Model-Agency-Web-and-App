...
@font-face {
        ...
        /* Top row: year badge + title + role pill */
        .exp-item-top {
            display: flex;
            align-items: center;
            flex-wrap: wrap;
        ...
        .exp-year-badge {
            ...
            color: var(--gold);
            background: var(--gold-bg);
            border: 1px solid rgba(var(--gold-rgb, 180, 120, 60), 0.25);
            padding: 3px 10px;
            border-radius: 2px;
...
.exp-role-pill::before {
    ...
    font-weight: 300;
        ...
        .exp-result-badge.is-won {
            background: rgba(22, 163, 74, 0.08);
            color: #16a34a;
            border: 1px solid rgba(22, 163, 74, 0.25);
        }

        .exp-result-badge.is-nominated {
            background: rgba(234, 179, 8, 0.08);
            color: #ca8a04;
            border: 1px solid rgba(234, 179, 8, 0.25);
        }

        /* Meta row: small icon + label chips */
        .exp-meta {
            display: flex;
            flex-wrap: wrap;
            gap: 6px 16px;
        ...
        /* Empty meta row: collapse spacing */
        .exp-meta:empty {
            display: none;
        }
        ...
        /* Notes (lighter than description) */
        .exp-notes {
            font-size: 0.9rem;
            color: var(--text-muted);
            margin-top: 6px;
    ...
    <div class="ap-shell">
        ...
        <div class="ap-header ap-fade-1">
            ...
            <div class="ap-identity">
                ...
                <div class="ap-tags">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($artist->profile?->categories)): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = array_slice($groups, 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <span class="ap-tag"><?php echo e($group); ?></span>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>

                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($groups) > 3): ?>
                            <span class="ap-tag" style="opacity: 0.6;">+<?php echo e(count($groups) - 3); ?> more</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            ...
            <div class="ap-actions">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->check() && (auth()->id() === $artist->id || auth()->user()->hasRole('Super-Admin'))): ?>
                    <a href="<?php echo e(route('photocard.download', $artist)); ?>"
                ...
                <div class="ap-panel" :class="activeTab === 'about' ? 'is-active' : ''">
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->showreel_url): ?>
                        <div class="ap-card">
                            ...
                            <div class="ap-card-body">
                                <a href="<?php echo e($artist->profile->showreel_url); ?>" target="_blank" class="btn-outline"
                            ...
                            <div class="ap-socials">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->facebook_url): ?>
                                    <a <?php echo $canAccessLinks ? 'href="' . $artist->profile->facebook_url . '"' : ''; ?> <?php echo $linkAttributes; ?> class="ap-social-btn">
                                        ...
                                        Facebook
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$canAccessLinks): ?> <svg width="10" height="10" viewBox="0 0 24 24" fill="none"
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile->facebook_followers): ?>
                                            <span style="font-size:0.7rem; opacity:0.7;">·
                                                <?php echo e(number_format($artist->profile->facebook_followers)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->instagram_url): ?>
                                    <a <?php echo $canAccessLinks ? 'href="' . $artist->profile->instagram_url . '"' : ''; ?> <?php echo $linkAttributes; ?> class="ap-social-btn">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile->instagram_followers): ?>
                                            <span style="font-size:0.7rem; opacity:0.7;">·
                                                <?php echo e(number_format($artist->profile->instagram_followers)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->youtube_url): ?>
                                    <a <?php echo $canAccessLinks ? 'href="' . $artist->profile->youtube_url . '"' : ''; ?> <?php echo $linkAttributes; ?> class="ap-social-btn">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile->youtube_followers): ?>
                                            <span style="font-size:0.7rem; opacity:0.7;">·
                                                <?php echo e(number_format($artist->profile->youtube_followers)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->tiktok_url): ?>
                                    <a <?php echo $canAccessLinks ? 'href="' . $artist->profile->tiktok_url . '"' : ''; ?> <?php echo $linkAttributes; ?> class="ap-social-btn">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile->tiktok_followers): ?>
                                            <span style="font-size:0.7rem; opacity:0.7;">·
                                                <?php echo e(number_format($artist->profile->tiktok_followers)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->linkedin_url): ?>
                                    <a <?php echo $canAccessLinks ? 'href="' . $artist->profile->linkedin_url . '"' : ''; ?> <?php echo $linkAttributes; ?> class="ap-social-btn">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile->linkedin_followers): ?>
                                            <span style="font-size:0.7rem; opacity:0.7;">·
                                                <?php echo e(number_format($artist->profile->linkedin_followers)); ?></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    </a>
                                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->hasMedia('portfolio')): ?>
                                ...
                                <div class="ap-portfolio-grid" 
                                    x-data="{
                                        isOpen: false,
                                        currentIndex: 0,
                                        images: <?php echo \Illuminate\Support\Js::from($artist->getMedia('portfolio')->map(fn($m) => $m->getUrl())->values())->toHtml() ?>,
                                        touchStartX: 0,
                                        touchEndX: 0,
                                        openGallery(index) {
                                ...
                                >
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $artist->getMedia('portfolio'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <div class="ap-portfolio-item" 
                                            @click="openGallery(<?php echo e($loop->index); ?>)"
                            ...
                            <div class="ap-card" style="margin-bottom: 20px;">
                                <div class="ap-card-head">
                                    ...
                                    <div class="ap-card-title">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'custom'): ?>
                                            <?php echo e($entries->first()->custom_type_label ?? 'Other'); ?>

                                        <?php else: ?>
                                            <?php echo e($expTypeLabels[$type] ?? ucwords(str_replace('_', ' ', $type))); ?>
                                ...
                                <div class="ap-card-body" style="padding: 0;">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($type, $awardStyleTypes)): ?>
                                        <div class="exp-list">
                                                ...
                                                <div class="exp-item">
                                                    <div class="exp-item-top">
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->year): ?>
                                                            <span class="exp-year-badge"><?php echo e($exp->year); ?></span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                                        
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->award_result): ?>
                                                            <?php
                                                                $isWon = in_array($exp->award_result, ['Won', 'Winner']);
                                                            ?>
                                                            <span class="exp-result-badge <?php echo e($isWon ? 'is-won' : 'is-nominated'); ?>">
                                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isWon): ?>
                                                        ...
                                                        <span class="exp-title"><?php echo e($exp->title); ?></span>
                                                    </div>

                                                    
                                                    <div class="exp-meta">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->award_category): ?>
                                                        ...
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'awards_achievements' && $exp->award_work): ?>
                                                            <span class="exp-meta-item">
                                                        ...
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->award_organizer): ?>
                                                            <span class="exp-meta-item">
                                                                ...
                                                                <?php echo e($exp->award_organizer); ?>

                                                            </span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($type === 'competitions_pageants' && $exp->jury_location): ?>
                                                            <span class="exp-meta-item">
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->description): ?>
                                                        <p class="exp-description"><?php echo e($exp->description); ?></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                </div>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                        </div>
                                    ...
                                    <?php elseif($type === 'workshop_training'): ?>
                                        <div class="exp-list">
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="exp-item">
                                                    <div class="exp-item-top">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div class="exp-item">
                                                    <div class="exp-item-top">
                                                        ...
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <span class="exp-title"><?php echo e($exp->title); ?></span>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->role): ?>
                                                            <span class="exp-role-pill"><?php echo e($exp->role); ?></span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>

                                                    <div class="exp-meta">
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->director): ?>
                                                            <span class="exp-meta-item">
                                                                ...
                                                                Dir. <?php echo e($exp->director); ?>

                                                            </span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->production): ?>
                                                            <span class="exp-meta-item">
                                                                <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/></svg>
                                                        ...
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->language): ?>
                                                            <span class="exp-meta-item">
                                                                ...
                                                                <?php echo e($exp->language); ?>

                                                            </span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->platform): ?>
                                                            <span class="exp-meta-item">
                                                                ...
                                                                <?php echo e($exp->platform); ?>

                                                            </span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>

                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->notes): ?>
                                                        <p class="exp-notes"><?php echo e($exp->notes); ?></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->description): ?>
                                                        <p class="exp-description"><?php echo e($exp->description); ?></p>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->date_of_birth): ?>
                                <div class="ap-attr">
                                    ...
                                    <span class="ap-attr-val"><?php echo e(\Carbon\Carbon::parse($artist->profile->date_of_birth)->age); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->skin_tone): ?>
                                ...
                                <div class="ap-attr">
                                    ...
                                    <span class="ap-attr-val" style="display: inline-flex; align-items: center; gap: 6px;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($skinHex): ?>
                                            <span style="width: 14px; height: 14px; border-radius: 4px; background-color: <?php echo e($skinHex); ?>; border: 1px solid rgba(0,0,0,0.15);"></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php echo e($artist->profile->skin_tone); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->eye_color): ?>
                                ...
                                <div class="ap-attr">
                                    ...
                                    <span class="ap-attr-val" style="display: inline-flex; align-items: center; gap: 6px;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($eyeHex): ?>
                                            
                                            <span style="width: 14px; height: 14px; border-radius: 50%; background-color: <?php echo e($eyeHex); ?>; border: 1px solid rgba(0,0,0,0.15);"></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php echo e($artist->profile->eye_color); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->hair_color): ?>
                                ...
                                <div class="ap-attr">
                                    ...
                                    <span class="ap-attr-val" style="display: inline-flex; align-items: center; gap: 6px;">
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($hairHex): ?>
                                            <span style="width: 14px; height: 14px; border-radius: 4px; background-color: <?php echo e($hairHex); ?>; border: 1px solid rgba(0,0,0,0.15);"></span>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                        <?php echo e($artist->profile->hair_color); ?><?php echo e($artist->profile->hair_length ? ' · ' . $artist->profile->hair_length : ''); ?>
                            ...
                            <div class="ap-attr">
                                ...
                                <span class="ap-attr-val"
                                    style="color: <?php echo e($artist->profile?->willing_to_travel ? '#16a34a' : 'var(--text-muted)'); ?>">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->id() === $artist->id): ?>
                        <div class="ap-sidebar-card" style="text-align: center; border-style: dashed;">
                            ...
                            <a href="<?php echo e(route('account.dashboard')); ?>" class="btn-outline"
            ...
            <div class="ap-modal-overlay">
                <div class="ap-modal">
                    ...
                    <p class="ap-modal-desc"
                        ...
                        আপনার পরবর্তী প্রজেক্টে <?php echo e($artist->name); ?>-কে পেতে চান? আমরা আপনার পাশে আছি। শিডিউল ও বিস্তারিত আলোচনার জন্য আমাদের টিমের সাথে সরাসরি কথা বলুন।
                    </p>
...
</div><?php /**PATH /home/dhakamodel/dhakamodel/resources/views/livewire/artist-profile.blade.php ENDPATH**/ ?>