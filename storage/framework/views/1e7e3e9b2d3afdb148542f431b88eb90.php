...
<div class="gb-page">
        ...
        <div class="gb-hero__inner">
            ...
            <div class="gb-hero__grid">
                <div>
                    <div class="gb-badge-row">
                        ...
                        ?>
                        <span class="gb-badge <?php echo e($statusClass); ?>"><?php echo e($statusLabel); ?></span>
                    </div>

                    <h1 class="gb-hero__title"><?php echo e($batch->title); ?></h1>
            ...
            <div class="gb-stat-strip">
                <div class="gb-stat">
                    ...
                    <div class="gb-stat__value gb-stat__value--gold">৳<?php echo e(number_format($batch->fee)); ?></div>
                </div>
                <div class="gb-stat">
                    <div class="gb-stat__label">Start Date</div>
                    <div class="gb-stat__value"><?php echo e($batch->start_date->format('d M, Y')); ?></div>
                </div>
                ...
                <div class="gb-stat">
                    ...
                    <div class="gb-stat__value"><?php echo e($batch->trainer); ?></div>
                </div>
                ...
                <div class="gb-stat gb-hide-mobile">
                    ...
                    <div class="gb-stat__value"><?php echo e($batch->venue); ?></div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="gb-stat gb-hide-mobile">
                    ...
                    <div class="gb-stat__value"><?php echo e($batch->remaining_seats); ?> / <?php echo e($batch->seat_limit); ?></div>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
        </div>
    ...
    <div class="gb-layout">
        ...
        <div class="gb-main">
            ...
            <div class="gb-ad"><?php if (isset($component)) { $__componentOriginaled4987d3f6007db3445a6067a328a16c = $component; } ?>
...
<?php endif; ?></div>
            ...
            <div class="gb-section">
                ...
                <div class="gb-description"><?php echo $batch->description; ?></div>
            </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="gb-section">
                ...
                <div class="gb-trainer-card">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($batch->trainer_image) && $batch->trainer_image): ?>
                        <img src="<?php echo e(asset('storage/' . $batch->trainer_image)); ?>"
                             alt="<?php echo e($batch->trainer); ?>"
                             class="gb-trainer-img">
                    <?php else: ?>
                        <div class="gb-trainer-initials">
                            <?php echo e(mb_strtoupper(mb_substr($batch->trainer, 0, 1))); ?>

                        </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <div>
                        <h3 class="gb-trainer-name"><?php echo e($batch->trainer); ?></h3>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($batch->trainer_designation) && $batch->trainer_designation): ?>
                            <p class="gb-trainer-role"><?php echo e($batch->trainer_designation); ?></p>
                        <?php else: ?>
                            <p class="gb-trainer-role">Lead Trainer</p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($batch->trainer_bio) && $batch->trainer_bio): ?>
                            <p class="gb-trainer-bio"><?php echo e($batch->trainer_bio); ?></p>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
            </div>
            ...
            <div class="gb-section">
                ...
                <div class="gb-benefits">
                    ...
                    <div class="gb-benefit">
                        ...
                        <h4 class="gb-benefit__title"><?php echo e($benefit['title']); ?></h4>
                        <p class="gb-benefit__desc"><?php echo e($benefit['description']); ?></p>
                    </div>
...
<?php endif; ?></div>
                ...
                <div class="gb-modules">
                    ...
                    <div class="gb-module">
                        ...
                        <div class="gb-module__body">
                            <div class="gb-module__name"><?php echo e($module['module_name']); ?></div>
                            <p class="gb-module__topics"><?php echo e($module['topics']); ?></p>
                        </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($batch->eligibility)): ?>
            <div class="gb-section">
                <div class="gb-section-head">
                ...
                <ul class="gb-eligibility-list">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $batch->eligibility; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <li>
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
                        <?php echo e(is_array($item) ? ($item['requirement'] ?? $item) : $item); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($batch->faqs)): ?>
            <div class="gb-section">
                <div class="gb-section-head">
                ...
                <div class="gb-faq">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $batch->faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $faq): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <div class="gb-faq-item" id="faq-<?php echo e($i); ?>">
                        <button class="gb-faq-q" onclick="gbToggleFaq(<?php echo e($i); ?>)">
                        ...
                        <div class="gb-faq-a"><?php echo e($faq['answer']); ?></div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                </div>
            </div>
        ...
        <div class="gb-sidebar">
            <div class="gb-sidebar-card">
                ...
                <div class="gb-sidebar-top">
                    ...
                    <div class="gb-sb-fee">৳<?php echo e(number_format($batch->fee)); ?></div>
                ...
                <div class="gb-sidebar-body">
                    ...
                    <div class="gb-sb-row">
                        ...
                        <div>
                            ...
                            <div class="gb-sb-val"><?php echo e($batch->start_date->format('d F, Y')); ?></div>
                        </div>
                    </div>
                    ...
                    <div class="gb-sb-row">
                        ...
                        <div>
                            ...
                            <div class="gb-sb-val"><?php echo e($batch->trainer); ?></div>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(isset($batch->trainer_designation) && $batch->trainer_designation): ?>
                                <div style="font-size:0.75rem; color:var(--g-faint); margin-top:2px;"><?php echo e($batch->trainer_designation); ?></div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="gb-sb-row">
                        ...
                        <div>
                            ...
                            <div class="gb-sb-val"><?php echo e($batch->venue); ?></div>
                        </div>
                    </div>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div style="width:100%">
                            ...
                            <div class="gb-seat-bar">
                                <div class="gb-seat-meta">
                                    <span class="gb-sb-val"><?php echo e($batch->remaining_seats); ?> seats left</span>
                                    <span style="font-size:0.78rem; color:var(--g-faint);"><?php echo e($batch->filled_seats); ?>/<?php echo e($batch->seat_limit); ?></span>
                                </div>
                                <div class="gb-seat-track">
                                    <div class="gb-seat-fill" style="width:<?php echo e($batch->fill_percentage); ?>%"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div><?php if (isset($component)) { $__componentOriginaled4987d3f6007db3445a6067a328a16c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaled4987d3f6007db3445a6067a328a16c = $attributes; } ?>
...
<?php endif; ?></div>
    ...
    <div class="gb-mobile-bar">
        <span class="gb-mobile-fee">৳<?php echo e(number_format($batch->fee)); ?></span>
...
<?php /**PATH /var/www/html/resources/views/livewire/grooming-batch-show.blade.php ENDPATH**/ ?>