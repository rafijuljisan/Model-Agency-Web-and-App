                                                ...
                                                <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                                                    ...
                                                    <tbody>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                            <tr style="border-bottom: 1px solid var(--border);">
                                                                <td style="padding: 10px 12px; color: var(--text-muted);"><?php echo e($exp['year'] ?? '—'); ?></td>
                                                                <td style="padding: 10px 12px; color: var(--text-primary); font-weight: 500;"><?php echo e($exp['title']); ?></td>
                                                                <td style="padding: 10px 12px; color: var(--text-secondary);"><?php echo e($exp['award_category'] ?? '—'); ?></td>
                                                                <td style="padding: 10px 12px; color: var(--text-secondary);"><?php echo e($exp['award_work'] ?? '—'); ?></td>
                                                                <td style="padding: 10px 12px;">
                                                                    <span style="font-size: 0.7rem; font-weight: 700; padding: 3px 8px; border-radius: 999px; <?php echo e(($exp['award_result'] ?? '') === 'Won' ? 'background: rgba(22,163,74,0.1); color: #16a34a;' : 'background: rgba(234,179,8,0.1); color: #ca8a04;'); ?>">
                                                                        <?php echo e($exp['award_result'] ?? '—'); ?>

                                                                    </span>
                                                                </td>
                                                                <td style="padding: 10px 12px; white-space: nowrap;">
                                                                    <button type="button" wire:click="editExperience(<?php echo e($exp['id']); ?>)" style="background: none; border: none; color: var(--gold); cursor: pointer; font-size: 0.75rem; margin-right: 8px;">Edit</button>
                                                                    <button type="button" wire:click="deleteExperience(<?php echo e($exp['id']); ?>)" onclick="return confirm('Delete this entry?')" style="background: none; border: none; color: #dc2626; cursor: pointer; font-size: 0.75rem;">Delete</button>
                                                                </td>
                                                            </tr>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                                                    </tbody>
                                                ...
                                                <div style="display: flex; justify-content: space-between; align-items: flex-start; padding: 10px 0; border-bottom: 1px solid var(--border);">
                                                    <div>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp['jury_festival']): ?>
                                                            <span style="color: var(--text-muted); font-size: 0.85rem;"> · <?php echo e($exp['jury_festival']); ?></span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp['jury_location']): ?>
                                                            <span style="color: var(--text-muted); font-size: 0.85rem;">, <?php echo e($exp['jury_location']); ?></span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp['year']): ?>
                                                            <span style="color: var(--text-muted); font-size: 0.8rem; margin-left: 8px;">(<?php echo e($exp['year']); ?>)</span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    </div>
                                                    ...
                                                    <tbody>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                            <tr style="border-bottom: 1px solid var(--border);">
                                                                <td style="padding: 10px 12px; color: var(--text-muted);"><?php echo e($exp['year'] ?? '—'); ?></td>
                                                                <td style="padding: 10px 12px; color: var(--text-primary); font-weight: 500;"><?php echo e($exp['title']); ?></td>
                                                                <td style="padding: 10px 12px; color: var(--text-secondary);"><?php echo e($exp['role'] ?? '—'); ?></td>
                                                                <td style="padding: 10px 12px; color: var(--text-muted); font-size: 0.8rem;"><?php echo e($exp['notes'] ?? ''); ?></td>
                                                                <td style="padding: 10px 12px; white-space: nowrap;">
                                                                    <button type="button" wire:click="editExperience(<?php echo e($exp['id']); ?>)" style="background: none; border: none; color: var(--gold); cursor: pointer; font-size: 0.75rem; margin-right: 8px;">Edit</button>
                                                                    <button type="button" wire:click="deleteExperience(<?php echo e($exp['id']); ?>)" onclick="return confirm('Delete this entry?')" style="background: none; border: none; color: #dc2626; cursor: pointer; font-size: 0.75rem;">Delete</button>
                                                                </td>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($showExpForm): ?>
                                <div style="background: var(--bg-primary); border: 1px solid var(--border); padding: 24px; border-radius: 4px;">
                                    <div class="form-grid-2" style="margin-bottom: 16px;">
                                        ...
                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(in_array($newExpType, ['film', 'tv_drama', 'commercial', 'theater', 'music_video', 'other'])): ?>
                                            <div class="form-field">
                                    ...
                                    <div style="display: flex; gap: 12px; justify-content: flex-end;">
                                        ...
                                        <button type="button" wire:click="saveExperience" class="btn-fill" style="font-size: 0.85rem; padding: 10px 24px;">
                                            <span wire:loading.remove wire:target="saveExperience"><?php echo e($editingExpId ? 'Update Entry' : 'Save Entry'); ?></span>
