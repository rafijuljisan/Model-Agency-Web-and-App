                ...
                <div class="ap-tags">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!empty($artist->profile?->categories)): ?>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($artist->profile->categories) > 3): ?>
                            <span class="ap-tag" style="opacity: 0.6;">+<?php echo e(count($artist->profile->categories) - 3); ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <tr style="border-bottom: 1px solid var(--border);">
                                                        <td style="padding: 12px 20px; color: var(--text-muted);">
                                                            <?php echo e($exp->year ?? '—'); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-primary); font-weight: 500;">
                                                            <?php echo e($exp->title); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-secondary);">
                                                            <?php echo e($exp->award_category ?? '—'); ?></td>
                                                        <td
                                                            style="padding: 12px 20px; color: var(--text-secondary); font-style: italic;">
                                                            <?php echo e($exp->award_work ?? '—'); ?></td>
                                                        <td style="padding: 12px 20px;">
                                                            <span
                                                                style="font-size: 0.68rem; font-weight: 700; padding: 3px 10px; border-radius: 999px; <?php echo e($exp->award_result === 'Won' ? 'background: rgba(22,163,74,0.1); color: #16a34a; border: 1px solid rgba(22,163,74,0.3);' : 'background: rgba(234,179,8,0.1); color: #ca8a04; border: 1px solid rgba(234,179,8,0.3);'); ?>">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                <div
                                                    ...
                                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->year): ?>
                                                        <span
                                                            style="font-size: 0.75rem; color: var(--gold); font-weight: 700; background: var(--gold-bg); padding: 2px 8px; border-radius: 2px; flex-shrink: 0; margin-top: 2px;"><?php echo e($exp->year); ?></span>
                                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                    <div>
                                                        <span
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->jury_category): ?>
                                                            <span style="color: var(--text-muted); font-size: 0.85rem;">,
                                                                <?php echo e($exp->jury_category); ?></span>
                                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->description): ?>
                                                        ...
                                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($exp->jury_festival): ?>
                                                            <div style="font-size: 0.82rem; color: var(--text-muted); margin-top: 2px;">
                                                                <?php echo e($exp->jury_festival); ?><?php echo e($exp->jury_location ? ', ' . $exp->jury_location : ''); ?>
                                                ...
                                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $entries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $exp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                                    <tr style="border-bottom: 1px solid var(--border);">
                                                        ...
                                                        <td style="padding: 12px 20px; color: var(--text-primary); font-weight: 500;">
                                                            <?php echo e($exp->title); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-secondary);">
                                                            <?php echo e($exp->role ?? '—'); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-secondary);">
                                                            <?php echo e($exp->director ?? '—'); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-secondary);">
                                                            <?php echo e($exp->production ?? '—'); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-secondary);">
                                                            <?php echo e($exp->language ?? '—'); ?></td>
                                                        <td style="padding: 12px 20px; color: var(--text-secondary);">
                                                            <?php echo e($exp->platform ?? '—'); ?></td>
                                                        <td
                                                            style="padding: 12px 20px; color: var(--text-muted); font-size: 0.8rem; font-style: italic;">
                                                            <?php echo e($exp->notes ?? ''); ?></td>
                                                    </tr>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($artist->profile?->hair_color): ?>
                                <div class="ap-attr">
                                    ...
                                    <span
                                        class="ap-attr-val"><?php echo e($artist->profile->hair_color); ?><?php echo e($artist->profile->hair_length ? ' · ' . $artist->profile->hair_length : ''); ?></span>
                                </div>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
