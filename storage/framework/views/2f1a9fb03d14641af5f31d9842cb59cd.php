...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Choose Your Plan']); ?>
...
═══════════════════════════════════════════ */
        ...
        .packages-grid {
            ...
            gap: 12px;
            /* was 3px — adds breathing room */
            margin-bottom: 40px;
            background: transparent;
            /* remove gray gap lines */
            border: none;
        }
        ...
        .payment-method-label:hover .pm-icon-wrap {
            transform: scale(1.07);
        }

        /* Selected states per brand */
        .payment-method-label input:checked~.pm-bkash {
            border-color: #E2136E;
            background: #FFF0F6;
        }

        .payment-method-label input:checked~.pm-bkash .pm-label {
            color: #E2136E;
        }

        .payment-method-label input:checked~.pm-nagad {
            border-color: #F15822;
            background: #FFF4EF;
        }

        .payment-method-label input:checked~.pm-nagad .pm-label {
            color: #F15822;
        }

        .payment-method-label input:checked~.pm-rocket {
            border-color: #8C3494;
            background: #F8F0FF;
        }

        .payment-method-label input:checked~.pm-rocket .pm-label {
            color: #8C3494;
        }
...
══════════════════════════════════════ */
    ...
    <div class="pricing-page">
        <form action="<?php echo e(route('packages.pay')); ?>" method="POST">
            <?php echo csrf_field(); ?>
            ...
            <div class="packages-grid anim-fade-up">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    <label class="package-label">
                        <input type="radio" name="package_id" value="<?php echo e($package->id); ?>" required <?php echo e($index === 0 ? 'checked' : ''); ?>>
                                ...
                                <ul class="package-features">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $package->features; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                        <li class="package-feature">
                                            <svg class="package-feature-check" width="14" height="14" viewBox="0 0 24 24"
            ...
            <div class="payment-section anim-fade-up anim-d2">
                ...
                <div class="payment-section-body">
                    ...
                    <div class="payment-instruction">
                        <svg class="payment-instruction-icon" width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <div class="payment-instruction-text">
                            ...
                            করুন। পেমেন্ট সম্পন্ন হলে নিচের ফর্মে আপনার মোবাইল নম্বর এবং ট্রানজেকশন আইডি (TrxID) প্রদান
                            করুন।
                        </div>
                    </div>
                    ...
                    <div class="payment-instruction" id="payment-number-display">
                        ...
                        <div class="payment-instruction-text">
                            ...
                            <span id="payment-account-type"
                                style="font-size:1.1rem; color:var(--text-muted); text-transform:uppercase; margin-top:2px; display:block;"></span>
                        </div>
                    </div>
                    ...
                    <div class="pay-field">
                        ...
                        <input id="p-sender" type="tel" name="sender_number" class="pay-input" required
                            placeholder="যেমন: 01XXXXXXXXX" autocomplete="tel">
                    ...
                    <div class="pay-field">
                        ...
                        <input id="p-trxid" type="text" name="trx_id" class="pay-input" required
                            placeholder="যেমন: 9J5A6B8C" autocomplete="off" style="letter-spacing:0.1em;">
        ...
        (function () {
            ...
            const prices = {
                <?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    '<?php echo e($package->id); ?>': '<?php echo e(number_format($package->price)); ?>',
    ...
    <script>
        (function () {
            ...
            const methods = {
                ...
                Rocket: { number: '<?php echo e($settings?->rocket_number); ?>', type: '<?php echo e($settings?->rocket_type); ?>' },
            };
...
<?php endif; ?><?php /**PATH /home/dhakamodel/dhakamodel/resources/views/packages.blade.php ENDPATH**/ ?>