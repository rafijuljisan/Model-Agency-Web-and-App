...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="auth-container anim-fade-up">
        ...
        <div class="auth-header">
            ...
            <h1 class="auth-title">Sign In to <strong><?php echo e(config('app.name')); ?></strong></h1>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="auth-footer">
                Don't have an account yet? <a href="<?php echo e(route('register')); ?>">Join as Talent</a>
            </div>
        </div>
...
<?php endif; ?><?php /**PATH /home/dhakamodel/dhakamodel/resources/views/auth/login.blade.php ENDPATH**/ ?>