                    ...
                    <div class="video-card">
                        ...
                        <?php else: ?>
                            ...
                            <div x-data="{ playing: false }" class="video-media-wrap">
                                ...
                                <template x-if="playing">
                                    <iframe src="<?php echo e($video->embed_url); ?>" class="video-iframe"
...
</div><?php /**PATH /home/dhakamodel/dhakamodel/resources/views/livewire/video-gallery.blade.php ENDPATH**/ ?>