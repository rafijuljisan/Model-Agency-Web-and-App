...
@font-face {
    ...
    src: local('SolaimanLipi'), url('https://themes.googleusercontent.com/static/fonts/earlyaccess/droidbengali/v1/DroidKufi-Regular.ttf') format('truetype');
    font-weight: normal;
    font-style: normal;
}
...
.form-page-eyebrow {
    ...
    font-weight: 600;
    letter-spacing: 0.2em; /* Slightly reduced spacing for Bengali readability */
    color: var(--gold);
    margin-bottom: 12px;
    display: flex;
    align-items: center;
...
@media (max-width: 768px) {
    ...
    .form-page-title { font-size: 2.8rem; }
    .casting-title { font-size: 2rem; }
    .casting-desc { font-size: 1.2rem; }
}
</style>
...
<div class="form-page">
    ...
    <div class="casting-list">
        @forelse($castings as $index => $casting)
            <div class="form-section anim-fade-up" style="animation-delay: {{ $index * 0.15 }}s">
                
                {{-- Header --}}
                <div class="form-section-header">
                    <div>
                        <div class="casting-type">{{ $casting->type }}</div>
                        <h2 class="casting-title">{{ $casting->title }}</h2>
                    </div>
                    @if($casting->status === 'Urgent' || $casting->status === 'জরুরী')
                ...
                <div class="form-section-body">
                    ...
                    <div class="casting-details-grid">
                        <div class="detail-block">
                            ...
                            <div>
                                ...
                                <div class="detail-value">{{ $casting->age_range }}</div>
                            </div>
                        </div>
                        ...
                        <div class="detail-block">
                            ...
                            <div>
                                ...
                                <div class="detail-value">{{ $casting->gender }}</div>
                            </div>
                        </div>
                        ...
                        <div class="detail-block">
                            ...
                            <div>
                                ...
                                <div class="detail-value">{{ $casting->experience }}</div>
                            </div>
                        </div>
                        ...
                        <div class="detail-block">
                            ...
                            <div>
                                ...
                                <div class="detail-value text-red-600 font-bold">{{ $casting->deadline }}</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="apply-box">
                        ...
                        @if($waNumber)
                            {{-- Bengali Translated WhatsApp URL --}}
                            <a href="https://wa.me/{{ $waNumber }}?text=হ্যালো!%20আমি%20'{{ urlencode($casting->title) }}'%20কাস্টিংয়ের%20জন্য%20আবেদন%20করতে%20চাই।" target="_blank" rel="noopener noreferrer" class="btn-whatsapp">
                                ...
                                হোয়াটসঅ্যাপের মাধ্যমে আবেদন করুন
                            </a>
                        @else
        ...
        @empty
            <div class="text-center text-gray-500 py-16 bg-white rounded-xl border border-gray-200">
                ...
                <p class="text-2xl font-bold text-gray-600 mb-2">কোনো কাস্টিং কল উপলব্ধ নেই</p>
                <p class="text-lg mt-1">আসন্ন প্রজেক্ট এবং অডিশনগুলির জন্য অনুগ্রহ করে কিছুদিন পর আবার চেক করুন।</p>
            </div>
        @endforelse
    </div>
