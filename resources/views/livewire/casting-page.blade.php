...
<div class="form-page">
    ...
    <div class="casting-list">
        @forelse($castings as $index => $casting)
            ...
            {{-- Anchor for direct-link sharing --}}
            <div id="casting-{{ $casting->id }}"
                 class="form-section anim-fade-up {{ $index === 0 ? 'is-latest' : '' }}"
                    ...
                    <div class="header-right">
                        ...
                        <div class="share-bar">
                            ...
                            <a class="share-btn share-btn--facebook"
                               href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(request()->url() . '#casting-' . $casting->id) }}"
                            ...
                            <button class="share-btn share-btn--instagram"
                                    onclick="castingShareInstagram('casting-{{ $casting->id }}')"
                            ...
                            <button class="share-btn share-btn--copy"
                                    id="copyBtn-{{ $casting->id }}"
                                    onclick="castingCopyLink('{{ $casting->id }}')"
                                    title="Copy link">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                                    <path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"/>
                                    <path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"/>
                                </svg>
                                <span id="copyText-{{ $casting->id }}">Copy</span>
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="collapse-body">
                    <div class="form-section-body">
                        ...
                        <div class="casting-details-grid">
                            ...
                            <div class="detail-block">
                                ...
                                <div>
                                    ...
                                    <div class="detail-value" style="color: var(--gold);">{{ $casting->deadline }}</div>
                                </div>
                            </div>
                        </div>

                        {{-- Description --}}
                        <div class="casting-desc">{{ $casting->description }}</div>
                        ...
                        <div class="apply-box">
                            ...
                            @if($waNumber)
                                <a href="https://wa.me/{{ $waNumber }}?text=হ্যালো!%20আমি%20'{{ urlencode($casting->title) }}'%20কাস্টিংয়ের%20জন্য%20আবেদন%20করতে%20চাই।"
                                   target="_blank" rel="noopener noreferrer"
                                   class="btn-whatsapp">
                ...
                {{-- ── TOGGLE BUTTON (hidden for latest) ──── --}}
                @if($index !== 0)
                ...
                @else
                    {{-- Latest card: small "সর্বশেষ" label at bottom --}}
