            ...
            <div class="form-section anim-fade-up" style="animation-delay: {{ $index * 0.15 }}s">
                ...
                <div class="form-section-body">
                    ...
                    <div class="apply-box">
                        ...
                        @if($waNumber)
                            <a href="https://wa.me/{{ $waNumber }}?text=Hello!%20I%20would%20like%20to%20apply%20for%20the%20{{ urlencode($casting->title) }}%20casting." target="_blank" rel="noopener noreferrer" class="btn-whatsapp">
