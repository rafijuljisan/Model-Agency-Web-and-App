        ...
        @elseif($currentStep === 'profile')
            ...
            @endif
                            ...
                            <div class="portfolio-thumbs">
                                @foreach($portfolioImages as $image)
                                    <div class="portfolio-thumb">
                                        ...
                                        <button type="button" class="portfolio-thumb-del" wire:click="deletePhoto({{ $image->id }})"
                ...
                <div class="form-submit-bar">
                    ...
                    <div>
                        <a href="{{ route('artist.show', auth()->id()) }}" target="_blank" class="btn-outline btn-mobile-icon" style="padding: 10px 16px; font-size: 0.85rem; display: flex; align-items: center; gap: 8px; border-color: var(--border-strong);" title="View Public Profile">
