                ...
                <div class="form-section anim-fade-up">
                    ...
                    <div class="form-section-body">
                        <p style="color: var(--text-muted); font-size: 0.9rem; margin-bottom: 24px; line-height: 1.6;">
                            To maintain the highest quality of talent, we require both a National ID and an Academic/Acting
                            Certificate. Please upload the required documents below.
                        </p>
                        ...
                        <form wire:submit.prevent="submitDocuments" class="space-y-6">
                            ...
                            @if(Auth::user()->verification_status === 'unverified')
                                <div
                                    style="padding: 20px; background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 6px; margin-bottom: 20px;">
                                    <h3
                                        style="font-weight: 600; color: var(--text-primary); margin-bottom: 12px; font-size: 0.95rem;">
                                        1. National ID (NID)</h3>
                                    @if(Auth::user()->nid_path)
                                        <p style="font-size: 0.75rem; color: #dc2626; margin-bottom: 12px; font-weight: 600;">Your
                                            previous NID was rejected. Please upload a clearer, original copy.</p>
                                    @endif
                                    ...
                                    @error('nidImage') <span
                                        style="color: #dc2626; font-size: 0.7rem; margin-top: 6px; display: block;">{{ $message }}</span>
                                    @enderror
                                    <div wire:loading wire:target="nidImage"
                                        style="color: var(--gold); font-size: 0.7rem; font-weight: 700; text-transform: uppercase; margin-top: 8px;">
                                        Uploading Preview...</div>
                                </div>
                            @else
                                <div
                                    style="padding: 16px 20px; background: rgba(22, 163, 74, 0.05); border: 1px solid rgba(22, 163, 74, 0.2); border-radius: 6px; display: flex; align-items: center; gap: 12px; margin-bottom: 20px;">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#16a34a"
                                        stroke-width="2">
                                        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                        <polyline points="22 4 12 14.01 9 11.01"></polyline>
                                    </svg>
                                    <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a;">National ID
                                        Verified</span>
                                </div>
                            @endif
                            ...
                            @if(Auth::user()->academic_verification_status === 'unverified')
                                <div
                                    style="padding: 20px; background: var(--bg-secondary); border: 1px solid var(--border); border-radius: 6px; margin-bottom: 24px;">
                                    <h3
                                        style="font-weight: 600; color: var(--text-primary); margin-bottom: 12px; font-size: 0.95rem;">
                                        2. Academic / Training Certificate</h3>
                                    @if(Auth::user()->academic_certificate_path)
                                        <p style="font-size: 0.75rem; color: #dc2626; margin-bottom: 12px; font-weight: 600;">Your
                                            previous certificate was rejected. Please upload a valid original document.</p>
                                    @endif
                                    <label class="upload-zone">
                            ...
                            @else
                                <div
                                    style="padding: 16px 20px; background: rgba(22, 163, 74, 0.05); border: 1px solid rgba(22, 163, 74, 0.2); border-radius: 6px; display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#16a34a"
                                        stroke-width="2">
                                        <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path>
                                        <polyline points="22 4 12 14.01 9 11.01"></polyline>
                                    </svg>
                                    <span style="font-size: 0.85rem; font-weight: 600; color: #16a34a;">Academic Certificate
                                        Verified</span>
                                </div>
                            @endif
