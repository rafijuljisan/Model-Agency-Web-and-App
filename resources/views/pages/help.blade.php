    ...
    <div class="help-shell anim-fade-up">
        ...
        <div class="support-strip">
            ...
            <div class="support-links">
                <a href="tel:{{ $settings->contact_phone }}" class="support-link">
                    ...
                    {{ $settings->contact_phone ?? '01926960164' }}
                </a>
                <a href="mailto:{{ $settings->contact_email }}" class="support-link">
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
                    {{ $settings->contact_email ?? 'Support Email' }}
                </a>
                <a href="https://wa.me/88{{ str_replace(' ', '', $settings->contact_phone ?? '01926960164') }}" target="_blank" class="support-link">
